...
import PEAttendance from '../views/check/PEAttendance'
  ...
  ]},
  {
    ...
    children: [
      ...
      ,{
        ...
        meta: { title: '心率图', icon: 'fa fa-bar-chart' }
      }
    ]
  },
  {
...
},
  {
    ...
    children: [{
      ...
      },
      {
        path: 'noticeAdd',
        name: 'noticeAdd',
        component: () => import('../components/affair/add/noticeAdd'),
        meta: { title: '公告添加', icon: ''}
      },
      {
        path: 'examAdd',
        name: 'examAdd',
