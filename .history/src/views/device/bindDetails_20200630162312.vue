      ...
      <div id="header">
        ...
        <p id="button" class="clearfix">
          ...
          <span class="right" style="margin:4px;display:inline-block;">
            <!-- {{getOptions}} -->
            <label>姓名</label><el-input v-model="rule.name"
            placeholder="请输入学生姓名"
        ...
        <el-select v-model="classifyObj" 
          style="width:110px; margin: 0 4px;" clearable
          ...
          placeholder="请选择年级" size="mini">
            ...
            <label style="">
        班级
        <el-select v-model="rule.className" style="width:110px; margin: 0 2px;" clearable
