  ...
  >
      ...
      <div id="header">
        ...
        <el-select v-model="classifyObj" 
          ...
          placeholder="请选择年级" size="mini">
            ...
            <label style="margin-left:4px;">
        班级
        <el-select v-model="rule.className" class="pickInput" clearable
    ...
    >
      ...
      >
        ...
        <el-form-item label="年级" prop="bandBind.gradeId">
        ...
        <el-form-item label="班级" prop="bandBind.classId">
        <el-select v-model="bandBind.classId" class="pickInput" clearable
           placeholder="请选择班级" size="mini" no-data-text="请先确定年级">
            <el-option 
              v-for="item in classList"
              :key="item.id"
