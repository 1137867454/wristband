      ...
      <template slot-scope="props">
        ...
        >
          <template slot-scope="scope">
            <el-button type="primary" size="mini" round @click="bluetoothAp.placeId=scope.row.placeOutputDTO.id;bindVisible = true;">
              <i class="el-icon-paperclip" style="font-size:13px;" />&nbsp;绑定</el-button>
            <!-- <el-button
              size="mini"
              type="danger"
              icon="el-icon-delete"
...
export default {
  ...
  methods: {
    ...
    deletes (index, row) {
      ...
      this.$store.dispatch('deleteclassroom_', arr)
    },
    updateclassroom_ () {
      // 教室信息修改
