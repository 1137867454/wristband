    ...
    <div class="height_100">
      <div class="cardHeader height_100">
        ...
        >
          ...
          <!-- <el-input
            v-model="rule.name"
            style="width:160px;vertical-align:middle;margin-left:18px;"
            clearable
            size="mini"
            placeholder="请输入学生姓名"
          /> -->
            <!-- <el-radio-button v-for="v in getGrade" label="一年级" /> -->
            <!-- <el-radio-button label="二年级" />
            <el-radio-button label="三年级" />
            <el-radio-button label="四年级" />
            <el-radio-button label="五年级" />
            <el-radio-button label="六年级" />
            <el-radio-button label="初一" />
            <el-radio-button label="初二" />
            <el-radio-button label="初三" />
          ...
          >
            ...
            <!-- <el-radio-button label="一班" />
            <el-radio-button label="二班" />
            <el-radio-button label="三班" />
            <el-radio-button label="四班" />
            <el-radio-button label="五班" />
            <el-radio-button label="六班" />
            <el-radio-button label="七班" /> -->
          </el-radio-group>
          <div class="classroom">
          <!-- <el-input
            v-model="rule.sid"
        ...
        if(pulse < 50 || pulse >180) {
          if(!this.dangerStudents.length) {
            ...
            this.$notify.error({
              ...
              onClose() {
                  let needDelete = this.dangerStudents.indexOf(wsdata.userName);
                  that.dangerStudents.splice(needDelete, 1);
                  console.log(that.dangerStudents)
                }
            });
          }else{
            ...
            if(!repeat) {
              ...
              this.$notify.error({
                ...
                onClose() {
                  let needDelete = this.dangerStudents.indexOf(wsdata.userName);
                  this.dangerStudents.splice(needDelete, 1);
