  ...
  >
    ...
    >
      ...
      >
        ...
        <el-table-column align="center" prop="studentCode" label="卡号" ></el-table-column>
        ...
        <el-table-column align="center" prop="gradeId" label="年级" width="200" ></el-table-column>
        <el-table-column align="center" prop="classId" label="班级" ></el-table-column>
      ...
      >
        ...
        <!-- 班级详细信息 -->
        <div style="height:300px;background:#fff;margin-top:4px;">
