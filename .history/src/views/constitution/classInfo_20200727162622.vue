      ...
      <div class="cardHeader height_100">
        ...
        <i class="icard" /> -->
          ...
          <ul style="height:200px;width:200px;border:solid 1px;position:relative;">
            <li class="heart_left" style="position:absolute;left:10px;height:100px;width:100px;border-radius:50%;background:linear-gradient(-90deg,#F50A45 0%,#d5093c 40%);">1</li>
