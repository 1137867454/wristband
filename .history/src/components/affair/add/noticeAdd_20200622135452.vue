       ...
       ref="noticeForm" :model="notification" :rules="rules"
        ...
        <p>
          <el-form-item label="年级" prop="gradeId"
           style="display:inline-block;">
            ...
            style="font-size:12px !important;width:240px;"
             v-model="notification.gradeId" placeholder="请选择通告年级">
          ...
          <el-form-item label="优先等级" prop="level" style="display:inline-block;">
            <el-select clearable size="small" 
            v-model="notification.level" style="width:240px;"
            placeholder="请选择公告等级">
        ...
        action="http://192.168.1.238:8777/brand/setNotificationPicture"
         method="post" enctype="multipart/form-data">
          <label style="color:#333;font-size:14px;margin-right:12px;">图片</label><input id="File1" name="uploadFile" 
        ...
        <el-form-item label-width="0" style="text-align:center;">
          ...
          <el-button size="medium" round @click="$router.push('/schoolAffair/AffairManage/adminHome')">取消</el-button>
        </el-form-item>
      </el-form>
  </div>
</template>
